...
interface ILearningCoursePageProps {
  path: string;
  showAttribution?: boolean;
}

const defaultProps: ILearningCoursePageProps = {
  path: '',
  showAttribution: true,
};

const LearningCoursePage: React.FC<ILearningCoursePageProps> = ({ path, showAttribution }: ILearningCoursePageProps) => {
...
LearningCoursePage.defaultProps = defaultProps;
